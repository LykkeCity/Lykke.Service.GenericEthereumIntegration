...
namespace Lykke.Service.GenericEthereumIntegration.Common.Filters
{
    public class ExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (_exceptionMappings.TryGetValue(exceptionType, out var statusCode))
            {
                ...
                {
                    var responseMessage = BlockchainErrorResponse.FromUnknownError(context.Exception.Message);
